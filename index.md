...
<table style="width=100%;border-collapse:collapse;border-spacing:15px;verticle-align:middle;text-align:center;">
	<tr>
		<td>
		...
		<td>
			<figure>
				...
				<figcaption><p style="text-align:center;">A 3D scene graph (3DSG) annotated with plannable attributes.</p></figcaption>
			</figure>
		</td>
	</tr>
</table>
